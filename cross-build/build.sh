...
if [ $x86 = yes -a ! -d /opt/rust/rustup/toolchains/*/lib/rustlib/i686-pc-windows-msvc/lib ]
then
...
# XXX: temporary fix
# https://github.com/ungoogled-software/ungoogled-chromium/pull/2816
test $ci = no || perl -pi -e 's/is_win/host_os == "win"/' components/domain_reliability/BUILD.gn
